  ...
  return (
    <section className="section-hero-details">
      ...
      <div className="hero-details-div">
        ...
        <p>
          Contrairement aux produits issue du recyclage "classique" aucune autre
          matière n'est ajoutée ce qui rend nos productions recyclables par la
          suite.
        </p>
      </div>
      <div className="hero-details-div">
        ...
        <p>
          ...
          produits de manière responsable et respectueuse de l'environement.
        </p>
      </div>
      <div className="hero-details-div">
